...
const COURSES: Course[] = [
    ...
    tasks: [
      {
        ...
        submissions: [
          { nim: "221011400114", nama: "ALDI AL KAHFI",      submittedAt: "10 Apr 2026, 14.30 WIB", fileName: "oop-aldi.zip",        nilai: 88,
            comments: [{ author: "Dr. Budi", role: "dosen", text: "Budi, tapi encapsulation perlu diperbaiki.", time: "11 Apr, 09.15" }] },
          { nim: "231011450403", nama: "Andi Pratama",    submittedAt: "10 Apr 2026, 23.55 WIB", fileName: "tugas1-andra.pdf" },
          { nim: "231011400651", nama: "Budi Santoso", submittedAt: "09 Apr 2026, 22.10 WIB", fileName: "oop-bagus.zip",        nilai: 92 },
          { nim: "231011450408", nama: "Candra Wiguna",     submittedAt: "10 Apr 2026, 11.00 WIB", fileName: "implementasi-oop.zip", nilai: 85 },
          { nim: "231011450284", nama: "Hendra Saputra",      submittedAt: "08 Apr 2026, 16.45 WIB", fileName: "oop-eki.pdf",          nilai: 95,
            comments: [
              { author: "Dr. Budi",     role: "dosen",     text: "Sangat baik! Polymorphism diimplementasikan dengan benar.", time: "09 Apr, 08.00" },
              { author: "Hendra Saputra", role: "mahasiswa", text: "Terima kasih pak, akan saya perbaiki bagian inheritance.", time: "09 Apr, 09.30" },
            ] },
      ...
      },
      {
        ...
        submissions: [
          { nim: "231011450284", nama: "Hendra Saputra", submittedAt: "26 Apr 2026, 15.00 WIB", fileName: "design-pattern-eki.pdf", nilai: 90 },
      ...
      { id: "pl-5", title: "Exception Handling",     deadline: "2026-05-19", type: "individu",  submissions: [] },
      {
        ...
        submissions: [
          { nim: "231011450284", nama: "Hendra Saputra", kelompok: "Kelompok Alfa", submittedAt: "01 Jun 2026, 10.00 WIB", fileName: "miniproject-alfa.zip" },
          { nim: "231011400651", nama: "Budi Santoso", kelompok: "Kelompok Beta", submittedAt: "31 Mei 2026, 23.00 WIB", fileName: "miniproject-beta.zip" },
        ],
      },
    ],
    enrollment: [
      ...
      { nim: "231011450403", nama: "Andi Pratama",    statuses: { "pl-1": "menunggu review", "pl-2": "belum mulai", "pl-3": "belum mulai", "pl-4": "belum mulai", "pl-5": "belum mulai", "pl-6": "belum mulai" } },
      { nim: "231011400651", nama: "Budi Santoso", statuses: { "pl-1": "selesai", "pl-2": "sedang dikerjakan", "pl-3": "belum mulai", "pl-4": "belum mulai", "pl-5": "belum mulai", "pl-6": "sedang dikerjakan" } },
      { nim: "231011450408", nama: "Candra Wiguna",     statuses: { "pl-1": "selesai", "pl-2": "belum mulai", "pl-3": "belum mulai", "pl-4": "belum mulai", "pl-5": "belum mulai", "pl-6": "belum mulai" } },
      { nim: "231011450284", nama: "Hendra Saputra",      statuses: { "pl-1": "selesai", "pl-2": "selesai", "pl-3": "sedang dikerjakan", "pl-4": "belum mulai", "pl-5": "belum mulai", "pl-6": "sedang dikerjakan" } },
  ...
  },
  {
    ...
    tasks: [
      {
        ...
        submissions: [
          ...
          { nim: "231011450408", nama: "Candra Wiguna",     submittedAt: "15 Apr 2026, 08.30 WIB", fileName: "erd-destran.pdf", nilai: 82 },
          { nim: "231011450284", nama: "Hendra Saputra",      submittedAt: "13 Apr 2026, 14.00 WIB", fileName: "erd-eki.pdf",    nilai: 91,
      ...
      { id: "bd-2", title: "Normalisasi 3NF",    deadline: "2026-04-30", type: "individu", submissions: [
        { nim: "231011450284", nama: "Hendra Saputra", submittedAt: "28 Apr 2026, 13.00 WIB", fileName: "normalisasi-eki.pdf", nilai: 88 },
        { nim: "231011450408", nama: "Candra Wiguna", submittedAt: "29 Apr 2026, 22.00 WIB", fileName: "3nf-destran.pdf" },
      ]},
    ...
    enrollment: [
      ...
      { nim: "231011450403", nama: "Andi Pratama",    statuses: { "bd-1": "sedang dikerjakan", "bd-2": "belum mulai", "bd-3": "belum mulai", "bd-4": "belum mulai", "bd-5": "belum mulai" } },
      { nim: "231011400651", nama: "Budi Santoso", statuses: { "bd-1": "menunggu review", "bd-2": "belum mulai", "bd-3": "belum mulai", "bd-4": "belum mulai", "bd-5": "belum mulai" } },
      { nim: "231011450408", nama: "Candra Wiguna",     statuses: { "bd-1": "selesai", "bd-2": "sedang dikerjakan", "bd-3": "belum mulai", "bd-4": "belum mulai", "bd-5": "belum mulai" } },
      { nim: "231011450284", nama: "Hendra Saputra",      statuses: { "bd-1": "selesai", "bd-2": "selesai", "bd-3": "sedang dikerjakan", "bd-4": "belum mulai", "bd-5": "belum mulai" } },
  ...
  },
  {
    ...
    enrollment: [
      { nim: "231011450408", nama: "Candra Wiguna",  statuses: { "rpl-1": "sedang dikerjakan", "rpl-2": "belum mulai", "rpl-3": "belum mulai", "rpl-4": "belum mulai" } },
      { nim: "231011450284", nama: "Hendra Saputra",   statuses: { "rpl-1": "belum mulai",        "rpl-2": "belum mulai", "rpl-3": "belum mulai", "rpl-4": "belum mulai" } },
